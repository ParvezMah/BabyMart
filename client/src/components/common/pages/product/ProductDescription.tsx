...
const ProductDescription = ({ product }: Props) => {
  ...
  return (
    <div className="w-full">
      ...
      >
        <TabsList className="grid w-full grid-cols-4 bg-babyshopWhite !h-14 border border-babyshopTextLight/30 rounded-xl p-1">
          <TabsTrigger
            value="description"
            className="py-2 text-babyshopBlack h-full hover:text-babyshopSky data-[state=active]:bg-babyshopSky data-[state=active]:text-babyshopWhite rounded-lg transition-all"
          >
            Description
          </TabsTrigger>
          <TabsTrigger
